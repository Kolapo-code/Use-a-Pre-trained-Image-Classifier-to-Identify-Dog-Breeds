...
def calculates_results_stats(results_dic):
    ...
    for key, value in results_dic.items():
        ...
        #           REPLACE pass with CODE that counts how many pet images of
        ...
        #           is a key in the results_stats_dic dictionary with its value 
        ...
        #           REPLACE pass with CODE that counts how many pet images 
        ...
        #           with its value representing the number of correctly 
    ...
    #           REPLACE zero(0.0) with CODE that calculates the % of correctly
    ...
    # Uses a conditional statement for when no 'not a dog' images were submitted 
